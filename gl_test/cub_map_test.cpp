...
unsigned int loadCubeTexture(std::vector<std::string> faces)
{
	...
	for (unsigned int i = 0; i < faces.size(); i++)
	{
		...
		data = stbi_load(faces[i].c_str(), &width, &height, &channel, 0);
		if (data)
		{
...
int main()
{
	...
	Shader shader("res/shader/reflection.vs", "res/shader/reflection.fs");
	Shader shaderSkybox("res/shader/sky_box.vs", "res/shader/sky_box.fs");
	Shader shaderModel("res/shader/model_shader.vs", "res/shader/reflection.fs");
	...
	pos = shader.getAtrributeLocation("aNormal");
	glEnableVertexAttribArray(pos);
	glVertexAttribPointer(pos, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)(3 * sizeof(float)));
	glBindVertexArray(0);
