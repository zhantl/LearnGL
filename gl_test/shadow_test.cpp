...
int main()
{
	...
	Shader simpleDepthShader("res/shader/shadow_mapping_depth.vs", "res/shader/shadow_mapping_depth.fs");
	Shader debugDepthQuad("res/shader/normal.vs", "res/shader/normal.fs");
	Shader shader("res/shader/shadow_shader.vs", "res/shader/shadow_shader.fs");
