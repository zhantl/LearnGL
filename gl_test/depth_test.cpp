...
int main()
{
	...
	// -------------------------
	Shader shader("res/shader/depth_test.vs", "res/shader/depth_test.fs");
	Shader shaderSingleColor("res/shader/depth_test.vs", "res/shader/depth_single_color.fs");
	...
	GLint pos = shader.getAtrributeLocation("aPos");
	glEnableVertexAttribArray(pos);
	glVertexAttribPointer(pos, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)0);
	pos = shader.getAtrributeLocation("aTexCoord");
	glEnableVertexAttribArray(pos);
	...
	pos = shader.getAtrributeLocation("aPos");
	glEnableVertexAttribArray(pos);
	glVertexAttribPointer(pos, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)0);
	pos = shader.getAtrributeLocation("aTexCoord");
	glEnableVertexAttribArray(pos);
